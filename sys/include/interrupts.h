...
/*the 1193182 constant comes from the old days of NTSC TV's, google if you want */
...
// #define MS_PER_TICK 0x03       /* 3ms per tick                      */
...
#ifdef SLB_THESIS
void kernel_to_ring0_proc(struct page_map_level_4_table *cr3, uint64_t, uint64_t);
#endif
